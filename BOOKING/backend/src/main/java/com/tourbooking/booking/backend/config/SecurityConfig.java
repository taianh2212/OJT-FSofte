    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .cors(cors -> cors.configurationSource(request -> {
                ...
                config.setAllowedOrigins(java.util.List.of("http://localhost:3000", "http://localhost:5500", "http://127.0.0.1:5500"));
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/v1/admin/chat/escalations", "/api/v1/admin/chat/escalations/**").hasAnyRole("ADMIN", "STAFF")
