...
public interface TourRepository extends JpaRepository<Tour, Long> {
    ...
    // Popularity sort (booking count) - Fixed to use subquery on Bookings table
    @Query(value = """
        SELECT t.*
        FROM dbo.Tours t
        LEFT JOIN (
    ...
    /**
     * Fetches a Tour with all lazy collections in one query to avoid LazyInitializationException.
     */
    ...
    /**
     * Fetches all Tours with images and city eagerly loaded (used by list/browse endpoints).
     */
