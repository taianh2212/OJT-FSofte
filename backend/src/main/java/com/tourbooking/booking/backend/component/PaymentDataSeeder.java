...
public class PaymentDataSeeder {
    ...
    public void seedPayments() {
        ...
        for (Booking booking : bookings) {
            // 1. If status is PENDING/CONFIRMED but has no payment, normalize to CONFIRMED.
            // DB check constraint does not accept SUCCESS for booking status.
        ...
        log.info("Seeding completed. Updated {} bookings to CONFIRMED, created {} payments.", updated, seeded);
    }
}
