...
public class ChatServiceImpl implements ChatService {
    ...
    private static final List<String> ESCALATION_KEYWORDS = List.of("nhÃƒÆ’Ã‚Â¢n viÃƒÆ’Ã‚Âªn", "human", "support", "help", "ngoÃƒÂ¡Ã‚ÂºÃ‚Â¡i lÃƒÂ¡Ã‚Â»Ã¢â‚¬Â¡");
    ...
    private void publishWaitingNotification(ChatSession session, String snippet) {
        ...
        notificationService.publish(
                com.tourbooking.booking.model.dto.response.ChatNotification.builder()
